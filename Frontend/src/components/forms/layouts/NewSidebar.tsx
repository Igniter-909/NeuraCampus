...
export default function NewSidebar({ navigationItems, role, userName, isCollapsed, setIsCollapsed, mobileMenuOpen, setMobileMenuOpen }: SidebarProps) {
  ...
  return (
    <div className="rounded-xl shadow-2xl shadow-blue-950 p-0 ">
      ...
      <div
        className={`
          fixed md:sticky rounded-xl top-0 left-0 h-[calc(100vh-2.5rem)] z-40
          bg-blue-500 text-white flex flex-col my-2
      ...
      >
        ...
        <div className="bg-blue-800 rounded-t-xl shadow-lg h-16 flex items-center justify-between px-5 flex-shrink-0">
        ...
        <div className="mt-auto  border-t border-white/10 bg-blue-800 rounded-b-xl flex-shrink-0">
          <button
            onClick={() => logout()}
            className={`
        ...
        <button
          ...
          className="absolute -right-3 top-6 hidden md:flex border-4 border-blue-50  shadow-blue-200 items-center justify-center w-6 h-6 rounded-full bg-blue-950 text-white shadow-2xl hover:bg-blue-700 transition-colors"
        >
